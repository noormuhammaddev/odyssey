...
class Applyonline_Admin{
    ...
    public function save_ad_closing($post_id){
        ...
        */
         ...
         * However the aurhor of the article failed to understand that this function only provides a READ ONLY access to Attachments to internal users only e.g. Administrator & AOL Manager.
         */
